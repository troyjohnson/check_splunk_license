...
my $search_string = "\'host=${host} index=_internal source=*/license_usage.log earliest_time=-0d\@d latest_time=now type!=RolloverSummary | eval mb=b/1024/1024 | stats sum(mb) as _raw\'";
